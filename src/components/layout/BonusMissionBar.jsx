...
export default function BonusMissionBar({ game }) {
  ...
  return (
    <div style={{ padding:"10px 14px",background:"#080018",border:`1px solid ${T.purple}40`,borderRadius:8,marginBottom:10 }}>
      <div style={{ fontFamily:"var(--font-ui)",fontSize:8,letterSpacing:3,color:T.purple,marginBottom:4 }}>
      ...
      <div style={{ fontFamily:"var(--font-ui)",fontSize:10,color:T.silver,lineHeight:1.5 }}>{game.bonusMission.desc}</div>
