  ...
  return (
    <div style={{ fontFamily:"var(--font-ui)",background:T.bg0,minHeight:"100vh",display:"flex",alignItems:"center",justifyContent:"center",padding:24,boxSizing:"border-box" }}>
      ...
      <div style={{ maxWidth:380,width:"100%",textAlign:"center" }}>
        ...
        <div style={{ fontFamily:"var(--font-ui)",fontSize:8,letterSpacing:3,color:T.dim,marginBottom:16,textAlign:"left" }}>YOUR NAME</div>
        <input value={form.name} onChange={e=>setForm(x=>({...x,name:e.target.value}))} placeholder="Your name" style={inp}
